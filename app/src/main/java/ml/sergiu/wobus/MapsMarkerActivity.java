...
public class MapsMarkerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // Add a marker in Cluj-Napoca, Romania,
        // and move the map's camera to the same location.
        LatLng cluj = new LatLng(46.7712, 23.6236);
        googleMap.addMarker(new MarkerOptions().position(cluj).title("Marker in Cluj-Napoca"));
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(cluj, 13));
    }
}
